...
DATA_PATH = os.path.join("..", "..", "data", "precios_vivienda")
...
def parse_htmls():
    ...
    sale_dir = os.path.join(DATA_PATH, "venta")
    rent_dir = os.path.join(DATA_PATH, "alquiler")
    ...
    df.to_csv(os.path.join(DATA_PATH, "precios_vivienda.csv"), index=False)
